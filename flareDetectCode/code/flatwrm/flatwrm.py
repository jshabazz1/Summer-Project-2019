...
from flatwrm.aflare import aflare1
...
def FindFlares(time,flux, period, window_var=1.5,
			   ...
			   detection_votes=4, returnbinary=True, N3=3, 
			   debug=False):
	'''
...
def GenerateOutput(time,flux,istart,istop,period,this_id, degree=10,\
	...
	if fit_events:
		header = "{:14}{:14}{:14}{:14}{:14}{:14}{:14}{:14}{:14}{:14}{:14}{:14}".format(\
				 "this_id",\
				 "t_start",\
				 "t_end",\
				 "t_max",\
		...
		header = "{:14}{:14}{:14}{:14}{:14}{:14}".format("this_id","t_start","t_end","t_max","lc_amp","raw_integral")
	...
	for i in range(len(istart)):
		...
		if fit_events:
			...
			if np.size(event_ind) > 0: 
				...
				outstring=this_id+','+\
						  "{:<14.4f}".format(t_start).strip()+','+\
						  "{:<14.4f}".format(t_stop).strip()+','+\
						  "{:<14.4f}".format(t_max).strip()+','+\
						  "{:<14.4f}".format(lc_amp).strip()+','+\
						  "{:<14.8f}".format(raw_integral).strip()+','+\
						  "{:<14.4f}".format(amp).strip()+','+\
						  "{:<14.4f}".format(popt1[1]).strip()+','+\
						  "{:<14.4f}".format(fit_t_start).strip()+','+\
						  "{:<14.4f}".format(fit_t_stop).strip()+','+\
						  "{:<14.4f}".format(fit_t_max).strip()+','+\
						  "{:<14.8f}".format(fit_int).strip()+','		  
			else:
				...
				outstring=this_id+','+\
						  ...
						  "{:<14.4f}".format(lc_amp).strip()+','+\
						  "{:<14.8f}".format(raw_integral).strip()+','+\
						  "{:<14.4f}".format(-99).strip()+','+\
						  "{:<14.4f}".format(-99).strip()+','+\
						  "{:<14.4f}".format(-99).strip()+','+\
						  "{:<14.4f}".format(-99).strip()+','+\
						  "{:<14.4f}".format(-99).strip()+','+\
						  "{:<14.8f}".format(-99).strip()+','		  
				pass
